...
@Transactional
@Rollback
public class MemberRepositoryTestVerDbunit {
	...
	@Test
	@DatabaseSetup("classpath:META-INF/dbunit/test_data_member.xml")
	@ExpectedDatabase(value = "classpath:META-INF/dbunit/afterupdate_data_member_test1.xml", assertionMode = DatabaseAssertionMode.NON_STRICT)
