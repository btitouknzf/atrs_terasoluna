...
public class TicketSearchControllerTestVerMockito {
	...
	public void setUp() throws Exception {
		...
		TicketSearchForm mockForm = new TicketSearchForm();
		mockForm.setFlightType(FlightType.RT);
		mockForm.setDepAirportCd("HND");
		mockForm.setArrAirportCd("HND");
		mockForm.setOutwardDate(begindate);
		mockForm.setHomewardDate(begindate);
		mockForm.setBoardingClassCd(BoardingClassCd.N);
		...
		mockDto.setReserveIntervalTime(intervalTime);
		
		when(ticketSearchHelper.createDefaultTicketSearchForm()).thenReturn(mockForm);
